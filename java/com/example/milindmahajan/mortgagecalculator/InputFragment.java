...
public class InputFragment extends Fragment {
    ...
    private boolean isValidForCalculation() {
        ...
        EditText homeValueEditText = (EditText) parentView.findViewById(R.id.homeValueInput);
        if (homeValueEditText.getText().length() == 0 || Float.parseFloat(homeValueEditText.getText().toString()) == 0.0) {
        ...
        EditText interestRateEditText = (EditText) parentView.findViewById(R.id.interestRateInput);
        if (interestRateEditText.getText().length() == 0 || Float.parseFloat(interestRateEditText.getText().toString()) == 0.0) {
        ...
        EditText taxRateEditText = (EditText) parentView.findViewById(R.id.taxRateInput);
        if (taxRateEditText.getText().length() == 0  || Float.parseFloat(taxRateEditText.getText().toString()) == 0.0) {
